...
('festive_enabled', '1', 'boolean', 'festive', 'Toggle Festive section on homepage on or off'),
('festive_banner_image', 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&w=2400&q=85', 'text', 'festive', 'Background image URL for the festive demi-couture showcase'),
('festive_badge', 'EID & FESTIVE 2026', 'text', 'festive', 'Optional badge / seasonal tag on festive banner'),
('festive_title', 'Festive', 'text', 'festive', 'Primary title text on festive banner card'),
('festive_subtitle', 'DEMI-COUTURE COLLECTION-26', 'text', 'festive', 'Subtitle text on festive banner card'),
('festive_btn1_text', 'FOR HER', 'text', 'festive', 'First CTA button label'),
('festive_btn1_link', '/shop/women', 'text', 'festive', 'First CTA button destination URL'),
('festive_btn2_text', 'FOR HIM', 'text', 'festive', 'Second CTA button label'),
('festive_btn2_link', '/shop/men?sub=Exclusive%20Panjabi', 'text', 'festive', 'Second CTA button destination URL'),
('festive_showcase_heading', 'EID & FESTIVE 2026 CURATIONS', 'text', 'festive', 'Section heading above product grid'),
('festive_products_filter', 'all', 'text', 'festive', 'Filter products displayed in festive showcase (all, men, women, belwari)'),
('festive_products_count', '12', 'number', 'festive', 'Number of products to display in festive showcase'),
('festive_explore_text', 'Explore More', 'text', 'festive', 'Bottom explore button text'),
('festive_explore_link', '/shop', 'text', 'festive', 'Bottom explore button destination URL');